...
class RegistroUpdateForm extends FormBase
{
	...
	function buildForm(array $form, FormStateInterface $form_state, $id = '') {
        ...
        $form['tipo_identificacion'] = array(
            ...
            '#options' => array('INE/IFE'=>t('INE/IFE'), 'Pasaporte'=>t('Pasaporte'), 'Cartilla Militar'=>t('Cartilla Militar'),
        ...
        $form['tipo_participante'] = array(
            ...
            '#options' => array('Participante' => t('Participante'),'Conferencista'=>t('Conferencista'),'Invitado Especial'=>t('Invitado Especial')),
	...
	function submitForm(array &$form, FormStateInterface $form_state) {
		...
		$conn->update('participante')->fields(
			array(
                'nombre' 		=> $nombre,
                'apaterno' 	=> $apaterno,
                'amaterno' 	=> $amaterno,
		...
		drupal_set_message(t('EL participante ha sido actualizado'));
