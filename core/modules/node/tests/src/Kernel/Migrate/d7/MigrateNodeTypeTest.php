...
class MigrateNodeTypeTest extends MigrateDrupal7TestBase {
  ...
  public function testNodeType() {
    ...
    $this->assertEntity('Hoteles', 'Hoteles entry', 'Use for multi-user blogs. Every user gets a personal blog.', 'Hoteles away, good sir!', TRUE, FALSE, $expected_available_menus, $expected_parent, 'Body');
